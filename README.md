...
For the Houdini case, place the required volumetric data in the directory specified in its README and run `LGNO.py`.
...
- The Houdini case expects externally generated volumetric `.npz` data.
